...
export const TRANSLATIONS = {
  en: {
    ...
    anyCherry: "2 Bells/Cherries return credits!",
    ...
    RETURN_2_BELL: "RETURN: 4 CR",
    RETURN_1_BELL: "RETURN: 1 CR",
    RETURN_2_CHERRY: "RETURN: 4 CR",
    RETURN_1_CHERRY: "RETURN: 1 CR",
  ...
  it: {
    ...
    anyCherry: "2 Campane/Ciliegie restituiscono crediti!",
    ...
    RETURN_2_BELL: "RITORNO: 4 CR",
    RETURN_1_BELL: "RITORNO: 1 CR",
    RETURN_2_CHERRY: "RITORNO: 4 CR",
    RETURN_1_CHERRY: "RITORNO: 1 CR",
