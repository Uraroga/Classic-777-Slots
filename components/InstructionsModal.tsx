        ...
        <div className="space-y-4 font-mono text-sm">
          ...
          <div className="bg-slate-900/50 p-3 rounded-lg border border-slate-700">
            ...
            <ul className="list-disc list-inside text-slate-300 space-y-1 text-xs">
              <li>3 x <span className="text-red-500 font-bold">7</span> = 100 {t.credits}</li>
              <li>3 x <span className="font-bold">BAR</span> = 40 {t.credits}</li>
              <li>3 x <span className="text-yellow-500 font-bold">{t.labelBell.toUpperCase()}</span> = 20 {t.credits}</li>
